    ...
    def renderIndexPage(self):
        ...
        try:
            ...
            routerCtrlApiUrl = f"http://{parent.listenAddr}:{parent.listenPort}/api/sshcmd" \
                               ...
                               f"username={controllerDefinitions['kabulctrl']}&commandString="
            # Insert the URL into the html template
            htmlFile = HTTPTools.insertAfter(htmlFile, "<apiUrlSendCmdToMikrotik>", routerCtrlApiUrl)
